...
# For PC/Laptop ONLY:
	...
	* Download File on Github (https://github.com/tri-hermawan/tools-ig/)
	* Extract File tools-ig and enter the folder
	* Right Click on Mouse, Then Select "Git Bash Here" (Make sure you are in the tools-ig folder!!!)
